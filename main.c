...
//第二阶段，多线程处理
extern void BufferMatchMultiThread();

SqStack * step3stack;
//第三阶段，处理全局栈
extern void BCSLeftHandle(Buffer*);
...
*/	
	...
	//第三阶段，处理全局栈 118ms
	//multi-thread中使用, 将step2阶段中的标签放入全局栈中
	pbuffer=start;
	BCSLeftHandle(pbuffer);
